...
const Footer = () => {
    return (
        <div className="bg-color">
            ...
            <div className="row">
                <div className="col-sm-12 col-md-6 col-lg-6 py-5 mt-5">
