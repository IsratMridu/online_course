...
const Footer = () => {
    return (
        <div className="bg-color">
            ...
            <div className="row">
                <div className="col-sm-12 col-md-6 col-lg-4 py-5 mt-5">
